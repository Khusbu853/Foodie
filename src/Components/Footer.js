        ...
        <div className="flex flex-wrap text-left lg:text-left items-center">
          <div className="w-full lg:w-6/12 px-4">
            ...
            <h5 className="text-lg mt-0 mb-2 text-blueGray-600">
              Come taste the magic at Foodie - where every bite is a love
              potion{" "}
              <i
            ...
            <div className="mt-6 lg:mb-0 mb-6">
              ...
              <a target="_blank" href="https://www.linkedin.com/in/khusbu-gupta-816a52201/">
                <button
              ...
              <a target="_blank" href="https://github.com/Khusbu853">
                <button
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="text-sm text-blueGray-500 font-semibold py-1">
              ...
              Foodie by{" "}
              <a
                href="https://github.com/Khusbu853"
